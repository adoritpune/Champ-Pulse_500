...
/*********************EEPRROM READ AT START=end	*******************/
   ...
   else
   {
	...
	pidParams2.Kp2	=32;	//40.0;//20.0;//5;
	pidParams2.Ki2	=9;		//5.0;//5.0;//10
	pidParams2.Kd2	=22;	//10.0;//0;//20 //5
...
void updatepccparameter(unsigned char encres3, unsigned char encres2)
{
	if(encres3!='$')
	{
		para.pmigmode.setwspeed=updatedata(para.pmigmode.setwspeed,mini.pmigmode.setwspeed,iMaxWSLimit,encres3);
