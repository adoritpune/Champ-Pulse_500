...
void superfast_PID(void)
{
	 ...
	 sf_kigain = 2;//2;//1//Recall_location;//pidParams.Ki;
...
void MIG_superfast_PID(void)
{
   ...
   sf_kpgain= intkp;//42;//30;//intkp;
   sf_kigain= intki;//2;//1.5;//intki;pidParams.Ki;
   sf_kdgain=intkd;//20;//10;//intkd;pidParams.Kd;	 
	...
	sf_error=sf_setpoint-sf_feedback;
	 ...
	 sf_pidoutput1=sf_pid>>sf_mig_scalefactor;

       New_variable=sf_pidoutpout1 - sf_error;
       sf_pidoutput=ACT_CVOLTAGE - New_variable;
